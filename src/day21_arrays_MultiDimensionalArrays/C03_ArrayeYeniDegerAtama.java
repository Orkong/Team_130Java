...
public class C03_ArrayeYeniDegerAtama {
    public static void main(String[] args) {
        ...
        // sonra da bizim array'imizi atama yapariz

        int[] geciciArr={4,2,6};
        arr1=geciciArr;
        System.out.println(Arrays.toString(arr1)); //[4, 2, 6]

        // eger yeni atadigimiz array default degerlerden olusan bir array
        // olacaksa new keyword kullanarak direk atama yapabiliriz
        ...
        // veya element silmek mumkun mudur?
        ...
        // var olan bir array'e uzunlugu degistirecek sekilde
        // yeni element ekleyemeyiz veya element silemeyiz
