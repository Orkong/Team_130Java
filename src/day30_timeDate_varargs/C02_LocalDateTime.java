...
public class C02_LocalDateTime {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tarihSaat); // 2023-11-30T13:01:29.203407700
        ...
        DateTimeFormatter istedigimF2 = DateTimeFormatter.ofPattern("dd MMMM YY EEEE HH MM a");

        System.out.println(tarihSaat.format(istedigimF2)); // 30 November 23 Thursday 13 11 PM

        // 11/30/2023 1:35
        DateTimeFormatter istedigimFormat3 = DateTimeFormatter.ofPattern("MM/dd/yyyy h:mm");
        System.out.println(tarihSaat.format(istedigimFormat3)); // 11/30/2023 1:40
