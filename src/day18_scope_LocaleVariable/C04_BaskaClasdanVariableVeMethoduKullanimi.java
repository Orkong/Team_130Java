...
public class C04_BaskaClasdanVariableVeMethoduKullanimi {

    public static void main(String[] args) {


        // Baska class'tan static class uyesi kullanmak icin
        ...
        C03_Scope_ClassVariableKullanim.method1(); //static method caslisti

        // static olmayan uyelere ulasmak icin ise
        // kullanmak istedigimiz class'tan obje olusturmaliyiz
        ...
        // Static member 'day18_scope_LocaleVariable.C03_Scope_ClassVariableKullanim.s' accessed via instance reference
        // static bir class uyesine, static olmayan yontemle ulasiyorsun

        System.out.println(obj.s); // null
        System.out.println(obj.a); //0
        obj.method1();  // static method caslisti
