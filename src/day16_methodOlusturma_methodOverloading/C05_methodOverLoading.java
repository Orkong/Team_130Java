...
public class C05_methodOverLoading {
    public static void main(String[] args) {
        ...
        // char ASCII sayesinde int'a donusebildigi icini
        // tolaYazdir(int,int) methodu kullanilabilir


        toplaYazdir(3.5f,5); // double ve int'in toplami : 8.5
        // float double degildir ama auto widening ile double bir degiskene float
        // deger atayabiliriz
    ...
    // parametre isimlerini degistirerek, ayni method'u 2 kere olusturabilir miyim?
    // java: method toplaYazdir(int,int) is already defined in class day16_methodOlusturma_methodOverloading.C05_methodOverLoading
    // Java parametrelerin adina degil, data turune bakiyor
    // yukaridaki method toplaYazdir(int, int) varkern yenisini olusturamazsiniz

    /*
        Java da method ismi ve parametrelerin data turleri birlikte dusunuldugunde
        ortaya cikan metne METHOD SIGNATUE denir.
        toplaYazdir(int, int)
