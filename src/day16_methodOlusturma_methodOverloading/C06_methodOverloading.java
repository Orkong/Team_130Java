...
public class C06_methodOverloading {
    public static void main(String[] args) {
        ...
        topla(3,5); // topla int int

        topla(6.3,5); // topla double int

        topla(2.4f,5); // topla float int

        topla(2.3,3.4); // topla double double ==> double double 5.699999999999999

        topla('a',5); // topla char int ==> int int :102

        topla(2.3f,3.5); // topla float float  ==> double double 5.799999952316284
