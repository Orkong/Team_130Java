...
public class C04_ArrayeElementEkleme {
    public static void main(String[] args) {
        ...
        //  arr[3]=eklenecekEleman;

        // once 4 kisilik bir yeni array olusturalim
        int[] yeniArr = new int[arr.length+1]; //  [0,0,0,0]

        // bir for loop olusturup
        // eski array'deki tum elementleri yeni array'e koyalayalim
        ...
        // en son element olarak yeniArr' ye eklenecek sayiyi atayalim
        ...
        System.out.println(Arrays.toString(arr)); // [3, 6, 7, 9, 1, 5, 7, 3]
