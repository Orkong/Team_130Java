...
public class C07_Runner {
    ...
    /*
        ...
        data turu'nun yaninda Constructor'da etkili olur.

        Bir objenin istenen ozelligi tasiyip tasimadigini
        data turu belirler

        O ozelligin daha guncel degerinin olup olmadigi ise
        contructor'a baglidir
        Java obje'nin ozelligi bulunduktan sonra
        constructor'in oldugu class'a kadar daha guncel bilgi olup
