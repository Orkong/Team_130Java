...
public class C02_Iterator {
    ...
    public static void main(String[] args) {
        ...
        for (Integer each: sayilar
            ...
            each = each+2;
            System.out.print(each + 2 + " "); // 7 3 9 5
        }
        ...
        // yaninda eleman varsa true yoksa false dondurur
        ...
        // iterator ile calisriken dikkat etmeiz gerekn en onemli konu
        // iterator'i nerede biraktigimizdir
        // bu soru icin dusunursek iterator en sona gitti
        // bir kere daha next() kullanirsak

        // System.out.println(iterator.next()); // NoSuchElementException

        // bu durumda iterator'a yeniden sifirdan baslayacak deger atanmasi yapmak lazim
        iterator = sayilar.iterator();

        // listedeki tum sayilari iterator ile silin

        while (iterator.hasNext()){ // iterator yaninda eleman oldugu surece true doner
