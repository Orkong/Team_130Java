...
public class C06_ArabaRunner {
    ...
    public static void main(String[] args) {
            ...
            // olusturulan obje
            // olusturuldugu class'da ilk atanmis olan degere sahip olur

            System.out.println(araba1); // Class'da toString varsa ozellikleri yazdirir

            //C02_Araba Ozellikleri{marka :'Marka belirtilmemis', model :'Model belirtilmemis', renk :'Renk belirtilmemis', yil :1990, fiyat :0
            ...
            //C02_Araba Ozellikleri{marka :'Opel', model :'Corsa', renk :'Yesil', yil :2000, fiyat :3000}
