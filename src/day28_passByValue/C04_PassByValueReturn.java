...
public class C04_PassByValueReturn {
    ...
    public static void main(String[] args) {
        /*
            Method'lar arasi gecinte
            variabl'in kendisi degil degeri yollanir

            her method'un icindeki local variable
            o method'da gecerli oldugundan
            main method'da atama carsa
            main method'daki fiyat variable'i kalici degisir
            diger method'da atama varsa o method'daki variable'in degeri degisir

            method her cagrildiginda sanki ilk defa calisiyor gibi
            sifirdan baslar
