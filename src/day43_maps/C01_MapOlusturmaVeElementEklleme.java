...
public class C01_MapOlusturmaVeElementEklleme {

    public static void main(String[] args) {
        /*
            Bir ogrenciyi map'e eklemek icin put(key,value) kullaniriz

            Bir ogrencinin value'sine ulasmak isterseniz
            - ogrenciMap.get(ogrenciNo) ile String olarak tum value'yu alip kaydederiz
            - value, pek cok bilgi barindirdigindan, her bir bilgiye ulasmak icin
        ...
        System.out.println("101 no'lu ogrenci soyismi : " + ogrenci101BilgilerArr[1]); // Can

        // 101 numarali ogrencinin bolumunu yazdirin

        System.out.println("101 no'lu ogrenci bolumu : " + ogrenci101BilgilerArr[4]); // MF

        // 101 numarali ogrencinin isim ve soyismini yazdirin

        System.out.println("101 no'lu ogrenci isim ve soyismi : "
