...
public class C05_IstenenOgrencininSoyIsminiUpdateEtme {
    ...
    public static void main(String[] args) {
        ...
        // eger bir map'te varolan key ile yeni bir element eklerseniz
        ...
        /*
            ...
            bunu onceki sorularda yapitgimiz gibi
        ...
        String  value110= ogrenciMap.get(110); // Azim-Mismis-11-K-TM
        ...
        String yeniValue = value110Arr[0]+"-"+value110Arr[1]+
                           "-"+value110Arr[2]+"-"+value110Arr[3]+"-"+value110Arr[4];
