...
public class C04_Increment_Decrement {
    ...
    public static void main(String[] args) {
        ...
        // a' nin degerini 1 artirin sonra a'nin degerini b'ye atayin
        ...
        // a'nin degerini yazdirin sonra a'nin degerini 1 artirin

        System.out.println("a nin degeri : "+ a); // 10
        a++;

        // bura a'nin degeri : 11

        a=10;

        //a'nin degerini bi artirin sonra yazdirin
