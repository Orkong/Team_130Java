...
public class C03_Equals_CompareTo {
    ...
    public static void main(String[] args) {
        ...
        // == ile StringBuilder'larin karsilastirilmasina itiraz etmez
        ...
        System.out.println(sb.compareTo(sb3)); // Java => Jale sonuc 10
        System.out.println(sb.compareTo(sb3)); // Java => Jandarma sonuc 8
